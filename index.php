...
<body>
        ...
        <tr class="wsite-multicol-tr">
          <td class="wsite-multicol-col" style="width:73%; padding:0 15px;">
            <h2 style="text-align:left;">
              <em>
                <font color="#E0915C" size="28px">Enlighten Your Career and Social Network</font>
              </em>
            </h2>
            <div class="paragraph" style="text-align:left;">
              
                <strong>
                  <font size="8px" color="#DA8044">in English Life Club</font>
                </strong>
	...
	<div class="my-container">
	<div class="jumbotron full-width-picture" style="height:500px;background: url('images/banner4_orig.jpg')">
